...
function initialiseLevelProgressComponent() {
    ...
    let levelProgressItemsHTML = `
        ...
        <div class="progress-entries custom-div border-bottom kanji-in-progress ${ levelProgressKanjiInProgressHTML == '' ? 'all-done' : '' }">
            <h2 class="progress-entry-header text-sm text-left leading-none tracking-normal font-bold"${ getHoverText(translationText.phrases.items_in_progress.en_meaning.replace('__', translationText.words.kanji.en_meaning)) }>
        ...
        <div class="progress-entries custom-div border-bottom radicals-in-progress ${ levelProgressRadicalsInProgressHTML == '' ? 'all-done' : '' }">
            <h2 class="progress-entry-header text-sm text-left leading-none tracking-normal font-bold"${ getHoverText(translationText.phrases.items_in_progress.en_meaning.replace('__', translationText.words.radical.en_meaning)) }>
        ...
        <div class="progress-entries custom-div border-bottom kanji-passed ${ levelProgressKanjiPassedHTML == '' ? 'all-done' : '' }">
            <h2 class="progress-entry-header text-sm text-left leading-none tracking-normal font-bold"${ getHoverText(translationText.phrases.items_passed.en_meaning.replace('__', translationText.words.kanji.en_meaning)) }>
        ...
        <div class="progress-entries custom-div border-bottom radicals-passed ${ levelProgressRadicalsPassedHTML == '' ? 'all-done' : '' }">
            <h2 class="progress-entry-header text-sm text-left leading-none tracking-normal font-bold"${ getHoverText(translationText.phrases.items_passed.en_meaning.replace('__', translationText.words.radical.en_meaning)) }>
        ...
        <div class="progress-entries custom-div kanji-locked ${ levelProgressKanjiLockedHTML == '' ? 'all-done' : '' }">
            <h2 class="progress-entry-header text-sm text-left leading-none tracking-normal font-bold"${ getHoverText(translationText.words.kanji_locked.en_meaning) }>
